...
function ChangeLog() {
    const changeLogArr = [
        ...
        `24.06.2022 Added password resetting on the login page, as well as more information for new users about what the site involves. Also added a fix for the Horse Race Politics All-Time leaderboard as it wasn't updating the Average Brier Score column. Also reduced the requirement to see your stats from Level 10 to 6, as Onboarding tasks were changed recently and this reduced requirement reflects that.`,
    ...
    return (
        <div className="change-log">
            <h1>Change Log</h1>
            <p>Here you'll find a list of short summaries explaining the work that's been going on to update Horse Race Politics. New additions, removals, tweaks, bug-fixes and much more will be documented here.</p>
            <br />
            <hr />

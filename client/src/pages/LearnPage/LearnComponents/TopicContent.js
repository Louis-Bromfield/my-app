...
export const TopicContent = [
    ...
    <div className="topic-text-paragraph">
        ...
        <p>Use the search page to search for the player you want to invite. At the top of the page will be a button that says "Invite to Team". Click this and the invite will send. You can also go to player profiles by clicking their username on their posts to your Feed on the Home page or their username in any leaderboard.</p>

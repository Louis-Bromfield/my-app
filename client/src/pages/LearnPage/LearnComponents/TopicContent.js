...
export const TopicContent = [
    ...
    <div className="topic-text-paragraph">
        ...
        <p><b>Time Score</b></p>
        <p>The Time Score is determined entirely by when you made your <b>FIRST</b> prediction. The later you make your first prediction, the smaller the bonus you will get. This ranges from 10 to 0.</p>
        <p><b>An Example</b></p>
        ...
        <p>My Time Score will be near to 10, as I forecasted incredibly quickly. Had I submitted my first prediction on say, Day 3, my Time Score would be around 7, however I was quick, so I get a nice boost.</p>
        <p>Let's say that I was right, and Candidate X did win. My Weighted Brier Scores for my certainties would be: </p>

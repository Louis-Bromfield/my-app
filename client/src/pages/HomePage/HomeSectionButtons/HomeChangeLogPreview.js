...
function HomeChangeLogPreview() {
    const changeLogArr = [
        `12.06.2022 Updated login page, changed profile picture styling, added handling for news feed posts with erroneous links (if this happens, users can now add their own titles to the post instead), added tabs to Search page, general styling and bug-fixing.`,

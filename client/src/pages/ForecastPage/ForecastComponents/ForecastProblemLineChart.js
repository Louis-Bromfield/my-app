            ...
            <h2>
                ...
                <FaInfoCircle 
                    ...
                    onClick={() => {
                        ...
                        setModalContent2(`The four buttons underneath the problem allow you to alter the chart, enabling you to display any permutation of All Forecasts, the Average Certainty, and the forecasts you yourself have made. Look under the chart for more info and data on the problem and market!`);
                    }}
                />
            </h2>

        ...
        <div className="forecast-problem-line-chart">
            ...
            <h2>
                ...
                <FaInfoCircle 
                    ...
                    onClick={() => { setShowModal(true); setModalContent(`This is the main visualisation of all forecasts made for the given problem. The chart displays the most recent prediction made by any user on each day (so if you submit 10 predictions today, only your tenth will show on the chart unless you update it again - in which case, your 11th will show instead). While this may obscure some data, it prevents the chart from becoming unreadable (if I submit 100 predictions today at each integer from 0-100, the chart would have a vertical line of data which is of no use to anybody). The four buttons underneath the problem allow you to alter the chart, enabling you to display any permutation of All Forecasts, the Daily Average Certainty, and the forecasts you yourself have made. The "Average Certainty Since Last Prediction" will only apper if the problem is still live (i.e. the deadline has not yet been reached), and there has been at least one day since the last prediction was submitted (e.g. if no one submits a prediction for a week, a straight line will be visible continuing the Daily Average Certainty since that last prediction). Look under the chart for more info and data on the problem and market!`)}}
                />
            </h2>

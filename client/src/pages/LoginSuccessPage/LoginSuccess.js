...
function LoginSuccess(props) {
    ...
    return (
        <div className="login-main-div">
            ...
            {loggedIn === true && <Link to="/home" onClick={() => props.login(usernameForHomePage)}><button className="login-success-btn">You've Logged In, Enter Horse Race Politics Here</button></Link>}
        </div>
    )
}
